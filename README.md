...
Agents resolve their own session (from the tmux pane, harness pid, or working directory),
...
| `tenex-edge launch <host>` | Spawn a host in a fresh tmux session, wired in. |
