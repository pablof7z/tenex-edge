...
Agents resolve their own session (from the pty pane, harness pid, or working directory),
...
| `tenex-edge launch <host>` | Spawn a host in a fresh pty session, wired in. |
