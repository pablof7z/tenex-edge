...
#[test]
fn validate_action_projects_rpc_params() {
    let action = ProbeAction::Validate {
...
#[test]
fn validate_action_preserves_bad_fact_text_for_daemon_evidence() {
    let action = ProbeAction::Validate {
        target: None,
