---
title: Mosaico MCP Client Identity
slug: mosaico-mcp-client-identity
topic: mosaico
summary: "Mcp-Session-Id is an HTTP transport correlation token, not a mosaico session identity or selector."
tags:
  - capture
volatility: warm
confidence: medium
...
does not identify a mosaico session and is never a public session selector.
<!-- [^4d656-84c25] -->
