---
title: Tenex-Edge Channel Workspace Binding
slug: tenex-edge-channel-workspace-binding
topic: tenex-edge
...
# Tenex-Edge Channel Workspace Binding
...
The channel→project architecture refactor is tracked as GitHub issue #201 in the tenex-edge repo, labeled `refactor:architecture`, `needs-human-policy`, and `risk:high`. <!-- [^bdb6c-b8501] -->
