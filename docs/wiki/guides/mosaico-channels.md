---
title: Mosaico Channels
slug: mosaico-channels
topic: mosaico
...
`mosaico channel add` puts an existing participant into a channel. It takes
...
delegated agent sessions with `mosaico dispatch <agent[@backend]>
--workspace <workspace> --message "..."`. <!-- [^661eb-712ca] -->

## Channel Switch

`mosaico channel switch` is an agent-only command. Channel paths are
