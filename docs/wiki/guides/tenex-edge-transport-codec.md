...
All outbound messages — including inbox send, inbox reply, and the owner-prompt path — are encoded through the NIP-29 kind1 codec via the single encode entry point in provider.rs, ensuring no codec-bypassing path exists and every outbound event receives the project-scoped `h` tag.
...
<!-- citations: [^f3a73-36] [^f3a73-37] [^f3a73-38] [^f3a73-46] [^f3a73-58] [^f3a73-79] [^f3a73-85] [^f3a73-97] [^d208c-1] [^36cc4-6] [^98f99-30] [^0bc06-6] [^ab999-44] [^ab999-63] [^ab999-74] [^40a4d-6] [^40a4d-8] [^cd74a-7] [^3a3de-2] -->
